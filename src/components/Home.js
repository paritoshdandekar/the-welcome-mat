                        ...
                        <div className="col s12 m6 l4">
                            <div className="card small hoverable">
                                ...
                                <div className="card-content">
                                    ...
                                    <Link to="/user/food" class="btn-floating waves-effect waves-light right"><i class="material-icons">arrow_right_alt</i></Link>
                                </div>
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card small hoverable">
                                ...
                                <div className="card-content">
                                    ...
                                    <Link to="/user/laundary" class="btn-floating waves-effect waves-light right"><i class="material-icons">arrow_right_alt</i></Link>
                                </div>
                                <div className="card-reveal">
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card small hoverable">
                                ...
                                <div className="card-content">
                                    ...
                                    <Link to="/user/housekeeping" class="btn-floating waves-effect waves-light right"><i class="material-icons">arrow_right_alt</i></Link>
                                </div>
                                <div className="card-reveal">
                        ...
                        <div className="col s12 m6 l4 push-l2">
                            <div className="card small hoverable">
                                ...
                                <div className="card-content">
                                    ...
                                    <Link to="/user/support" class="btn-floating waves-effect waves-light right"><i class="material-icons">arrow_right_alt</i></Link>
                                </div>
                                <div className="card-reveal">
                        ...
                        <div className="col s12 m6 l4 push-l2">
                            <div className="card small hoverable">
                                ...
                                <div className="card-content">
                                    ...
                                    <Link to="/user/internet" class="btn-floating waves-effect waves-light right"><i class="material-icons">arrow_right_alt</i></Link>
                                </div>
                                <div className="card-reveal">
